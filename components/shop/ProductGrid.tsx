      ...
      <div className="hidden md:flex flex-col border-b border-black/5 pb-4 mb-2">
        <div className="flex items-center justify-between py-2">
          ...
          <button 
            ...
            className="flex items-center gap-2 font-inter text-lg px-4 py-1.5 border-2 border-black/90 text-black hover:bg-[#0350F0] hover:border-[#0350F0] hover:text-white transition-all tracking-wider"
          >
            <Ruler size={16} />
            SIZE CHART
          </button>
