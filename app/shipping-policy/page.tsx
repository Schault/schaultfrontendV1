        ...
        <main className="min-h-screen bg-[#F5F5F5]">
            ...
            <section className="bg-white">
                <div className="mx-auto max-w-4xl px-6 py-12 md:px-12 font-inter text-black/80 space-y-6 leading-relaxed">
                    ...
                    <h2 className="font-inter text-2xl tracking-wide text-black mt-10 mb-4">1. Order Processing</h2>
                    ...
                    <h2 className="font-inter text-2xl tracking-wide text-black mt-10 mb-4">2. Shipping Methods</h2>
                    <ul className="list-disc pl-6 space-y-2">
                        <li>We offer standard shipping across India.</li>
                        <li>Additional shipping options (if available) will be shown at checkout.</li>
                    </ul>

                    <h2 className="font-inter text-2xl tracking-wide text-black mt-10 mb-4">3. Delivery Timeframes</h2>
                    <ul className="list-disc pl-6 space-y-2">
                    ...
                    <h2 className="font-inter text-2xl tracking-wide text-black mt-10 mb-4">4. Shipping Charges</h2>
                    <ul className="list-disc pl-6 space-y-2">
                    ...
                    <h2 className="font-inter text-2xl tracking-wide text-black mt-10 mb-4">5. Order Tracking</h2>
                    <ul className="list-disc pl-6 space-y-2">
                    ...
                    <h2 className="font-inter text-2xl tracking-wide text-black mt-10 mb-4">6. Delivery Issues and Delays</h2>
                    ...
                    <h2 className="font-inter text-2xl tracking-wide text-black mt-10 mb-4">7. Incorrect Address or Failed Delivery</h2>
                    <ul className="list-disc pl-6 space-y-2">
                    ...
                    <h2 className="font-inter text-2xl tracking-wide text-black mt-10 mb-4">8. Damaged or Missing Packages</h2>
                    <ul className="list-disc pl-6 space-y-2">
                    ...
                    <h2 className="font-inter text-2xl tracking-wide text-black mt-10 mb-4">9. International Shipping</h2>
                    <ul className="list-disc pl-6 space-y-2">
                    ...
                    <h2 className="font-inter text-2xl tracking-wide text-black mt-10 mb-4">10. Contact Us</h2>
