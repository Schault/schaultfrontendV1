        ...
        <main className="min-h-screen bg-[#F5F5F5]">
            ...
            <section className="bg-white">
                <div className="mx-auto max-w-4xl px-6 py-12 md:px-12 font-inter text-black/80 space-y-6 leading-relaxed">
                    ...
                    <h2 className="font-inter text-2xl tracking-wide text-black mt-10 mb-4">1. Eligibility and Account Terms</h2>
                    ...
                    <h2 className="font-inter text-2xl tracking-wide text-black mt-10 mb-4">2. Pricing and Payment</h2>
                    <ul className="list-disc pl-6 space-y-2">
                    ...
                    <h2 className="font-inter text-2xl tracking-wide text-black mt-10 mb-4">3. Product Descriptions</h2>
                    <ul className="list-disc pl-6 space-y-2">
                    ...
                    <h2 className="font-inter text-2xl tracking-wide text-black mt-10 mb-4">4. Order Acceptance and Cancellation</h2>
                    ...
                    <h2 className="font-inter text-2xl tracking-wide text-black mt-10 mb-4">5. Shipping and Delivery</h2>
                    <ul className="list-disc pl-6 space-y-2">
                    ...
                    <h2 className="font-inter text-2xl tracking-wide text-black mt-10 mb-4">6. Returns and Refunds</h2>
                    ...
                    <h2 className="font-inter text-2xl tracking-wide text-black mt-10 mb-4">7. Prohibited Uses</h2>
                    ...
                    <h2 className="font-inter text-2xl tracking-wide text-black mt-10 mb-4">8. Intellectual Property</h2>
                    ...
                    <h2 className="font-inter text-2xl tracking-wide text-black mt-10 mb-4">9. Limitation of Liability</h2>
                    ...
                    <h2 className="font-inter text-2xl tracking-wide text-black mt-10 mb-4">10. Indemnification</h2>
                    ...
                    <h2 className="font-inter text-2xl tracking-wide text-black mt-10 mb-4">11. Third-Party Services</h2>
                    ...
                    <h2 className="font-inter text-2xl tracking-wide text-black mt-10 mb-4">12. Governing Law</h2>
                    ...
                    <h2 className="font-inter text-2xl tracking-wide text-black mt-10 mb-4">13. Changes to Terms</h2>
                    ...
                    <h2 className="font-inter text-2xl tracking-wide text-black mt-10 mb-4">14. Contact Information</h2>
            ...
            <section className="bg-[#111111] py-16 px-6 text-center">
                <div className="mx-auto max-w-3xl">
                    <h2 className="font-inter text-3xl md:text-5xl tracking-wide text-white mb-6">REDEFINE FOOTWEAR</h2>
