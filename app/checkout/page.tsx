                ...
                <div className="space-y-6">
                    ...
                    {items.map((item) => (
                      <div key={item.id} className="flex gap-4 border-b border-black/5 pb-4 last:border-0 last:pb-0">
                        ...
                        <div className="flex flex-1 flex-col justify-center">
                          ...
                          <p className="mt-2 font-inter text-sm font-semibold text-black/90">
                  ...
                  <div className="border-t border-black/10 pt-6 space-y-4">
                    <div className="flex justify-between font-inter text-sm">
                      ...
                      <span className="font-medium text-black/90">${totalPrice.toFixed(2)}</span>
                    </div>
                    <div className="flex justify-between font-inter text-sm">
                      <span className="text-black/70">Shipping</span>
                      <span className="font-medium text-black/90">Free</span>
                    </div>
                    <div className="flex justify-between border-t border-black/10 pt-4 font-bebas text-2xl tracking-wide">
                      <span className="text-black/90">Total</span>
                      <span className="text-[#CC0000]">${totalPrice.toFixed(2)}</span>
                    </div>
                  </div>
                </div>
              )}
