        ...
        <main className="min-h-screen bg-[#F5F5F5]">
            ...
            <section className="bg-white">
                <div className="mx-auto max-w-4xl px-6 py-12 md:px-12 font-inter text-black/80 space-y-6 leading-relaxed">
                    ...
                    <h2 className="font-inter text-2xl tracking-wide text-black mt-10 mb-4">1. Return Eligibility</h2>
                    ...
                    <h2 className="font-inter text-2xl tracking-wide text-black mt-10 mb-4">2. Return Timeframe</h2>
                    <ul className="list-disc pl-6 space-y-2">
                    ...
                    <h2 className="font-inter text-2xl tracking-wide text-black mt-10 mb-4">3. Exchange Policy</h2>
                    ...
                    <h2 className="font-inter text-2xl tracking-wide text-black mt-10 mb-4">4. Refund Process</h2>
                    <ul className="list-disc pl-6 space-y-2">
                    ...
                    <h2 className="font-inter text-2xl tracking-wide text-black mt-10 mb-4">5. Return Shipping</h2>
                    <ul className="list-disc pl-6 space-y-2">
                    ...
                    <h2 className="font-inter text-2xl tracking-wide text-black mt-10 mb-4">6. Damaged or Defective Products</h2>
                    ...
                    <h2 className="font-inter text-2xl tracking-wide text-black mt-10 mb-4">7. Non-Returnable Items</h2>
                    ...
                    <h2 className="font-inter text-2xl tracking-wide text-black mt-10 mb-4">8. Late or Missing Refunds</h2>
                    ...
                    <h2 className="font-inter text-2xl tracking-wide text-black mt-10 mb-4">9. Contact Us</h2>
